            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Product">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.product.fields.new') }}
                        </th>
                        <th>
                            {{ trans('cruds.product.fields.photo') }}
                        </th>
                        <th>
                            {{ trans('cruds.product.fields.technical_fiche') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($products as $key => $product)
                        <tr data-entry-id="{{ $product->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $product->new ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $product->new ? 'checked' : '' }}>
                            </td>
                            <td>
                            ...
                            <td>
                                @foreach($product->technical_fiche as $key => $media)
