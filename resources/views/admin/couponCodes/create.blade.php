    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.coupon-codes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reward') ? 'is-invalid' : '' }}" type="number" name="reward" id="reward" value="{{ old('reward', '') }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_disposable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_disposable" id="is_disposable" value="1" {{ old('is_disposable', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('used_at') ? 'is-invalid' : '' }}" type="text" name="used_at" id="used_at" value="{{ old('used_at') }}">
