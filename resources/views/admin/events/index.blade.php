        ...
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Event">
            <thead>
                <tr>
                    ...
                    <th>
                        {{ trans('cruds.event.fields.how_many_people') }}
                    </th>
                    <th>
                        {{ trans('cruds.event.fields.location') }}
                    </th>
                    <th>
                        {{ trans('cruds.event.fields.contact_information') }}
                    </th>
                    <th>
                        {{ trans('cruds.event.fields.starts') }}
                    </th>
                    <th>
                        {{ trans('cruds.event.fields.ends') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
...
{ data: 'how_many_people', name: 'how_many_people' },
