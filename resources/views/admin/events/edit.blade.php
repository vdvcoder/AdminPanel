    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.update", [$event->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('information') ? 'is-invalid' : '' }}" type="text" name="information" id="information" value="{{ old('information', $event->information) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('how_many_people') ? 'is-invalid' : '' }}" type="number" name="how_many_people" id="how_many_people" value="{{ old('how_many_people', $event->how_many_people) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_information') ? 'is-invalid' : '' }}" type="text" name="contact_information" id="contact_information" value="{{ old('contact_information', $event->contact_information) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('starts') ? 'is-invalid' : '' }}" type="text" name="starts" id="starts" value="{{ old('starts', $event->starts) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('ends') ? 'is-invalid' : '' }}" type="text" name="ends" id="ends" value="{{ old('ends', $event->ends) }}">
                @if($errors->has('ends'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ends') }}
                    </div>
